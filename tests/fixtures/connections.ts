...
export const developmentConnectionsPuzzle: ConnectionsPuzzle = {
...
export const testConnectionsPuzzle: ConnectionsPuzzle = {
  id: "test-connections-puzzle",
  title: "Test Connections Puzzle",
  groups: [
    {
      id: "group-letters",
      category: "Letters",
